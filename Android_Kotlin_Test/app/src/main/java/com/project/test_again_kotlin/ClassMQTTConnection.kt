...
import com.project.test_again_kotlin.ClassKonteksti.Companion.context
import org.eclipse.paho.android.service.MqttAndroidClient
import org.eclipse.paho.client.mqttv3.*


class ClassMQTTConnection(context: Context?,
                          serverURI: String,
                          clientID: String = "") {
    ...
    // fun connect() {
        ...
        mqttAndroidClient = MqttAndroidClient ( applicationContext, "192.168.1.171","YOUR CLIENT ID" )
        try {
